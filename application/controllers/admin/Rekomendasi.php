...
class Rekomendasi extends Super
{
    ...
    function __construct()
    {
        ...
        $this->tabel          = "produk_rekomendasi";
        $this->active_id_menu = "produk rekomendasi";
        $this->nama_view      = "Produk Rekomendasi";
        $this->status         = true; 
        $this->field_tambah   = array('produk'); 
        $this->field_edit     = array('produk'); 
    ...
    function index(){
            ...
            **/
            $this->crud->set_relation('produk','produk','nama_produk');
