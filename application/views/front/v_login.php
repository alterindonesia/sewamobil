...
<div class="message warning">
    <div class="inset">
        ...
        <form method="post" action="">
            ...
            <div class="clear"> </div>
            <div class="submit">
                <input style="width: 100%" type="submit" value="Sign in" name="login">
                <!-- <h4><a href="#">Lost your Password ?</a></h4> -->
                <div class="clear">  </div>
            </div>
            <div class="clear"> </div>
            <p style="margin-top: 20px">Belum punya akun? <span><a href="<?= base_url('index/registrasi') ?>">Daftar Sekarang</a></span></p>
