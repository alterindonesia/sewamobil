            					...
            					<tr>
                                    ...
                                    <td style="text-align: center; font-size: 10pt">
                                        <?php if ($key->status_pembayaran == "Pembayaran Berhasil"): ?>
                                            <span style="background-color: #8bc34a" class="badge badge-success">
                                                <?= $key->status_pembayaran ?>
                                            </span>

                                            <?php elseif($key->status_pembayaran == "Verifikasi Pembayaran"): ?>
            						...
            						<td>
            							<a href="<?= base_url('admin/booking/update/'.$key->id_transaksi) ?>">
