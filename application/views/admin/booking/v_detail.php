            	...
            	<div class="col-md-offset-3 col-md-6 col-xs-12"> 
                        ...
                        <?php if ($row->status_pembayaran == "Pembayaran Berhasil"): ?>
                                <th colspan="2" style="text-align: center; color: #8bc34a">
                                    <h3 style="text-align: center; color: #8bc34a">
                                ...
                                <?php elseif ($row->status_pembayaran == "Menunggu Pembayaran"): ?>
                                ...
                                <?php elseif ($row->status_pembayaran == "Pembayaran Gagal"): ?>
                                    ...
                                    <th colspan="2" style="text-align: center;">
                                        <h3 style="color: red">
                                            <i style="font-size: 32pt;" class="fa fa-times-circle" aria-hidden="true"></i>
                                            <span><?= $row->status_pembayaran ?></span>
                                        </h3><br>
                            ...
                            <!-- <form action="" method="post" enctype="multipart/form-data" accept-charset="utf-8" style="margin-bottom: 10%; border: #e0e0e0 2px solid; padding: 20px" id="main-form"> -->
                                    <div class="submit" id="onSubmit">
                                        ...
                                        <div class='form-field-box odd'>
                                            ...
                                            <div class='form-input-box'>
                                                <input class='form-control' name='nama_penyewa' value="<?= $row->nama_user ?>" type='text' readonly="readonly"/>                
                                            </div>
                                            <br>
                                            <div class='clear'></div>
                                        </div>
                                        ...
                                        <div class='form-field-box odd'>
                                            ...
                                            <div class='form-input-box'>
                                                <input style="font-weight: bold;" class='form-control' name='jumlah_hari' value="BANK <?= $row->bank_tujuan ?>" type='text' readonly="readonly" />         
                                            </div>
                                            <br>
                                            <div class='clear'></div>
                                        </div>
                                        ...
                                        <div class='form-field-box odd'>
                                            ...
                                            <div class='form-input-box'>
                                                <input style="font-weight: bold; font-size: 14pt" class='form-control' name='jumlah_hari' value="Rp<?= number_format($row->total_bayar) ?>" type='text' readonly="readonly" />         
                                            </div>
                                            <br>
                                            <div class='clear'></div>
                                        </div>
