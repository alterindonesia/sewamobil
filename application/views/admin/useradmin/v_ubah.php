                                    ...
                                    <div class="submit" id="onSubmit">
                                        ...
                                        <div class='form-field-box odd'>
                                            ...
                                            <div class='form-input-box'>
                                                <input class='form-control' name='nama' value="<?= $row->nama ?>" type='text'/>                
                                            </div>
                                            <br>
                                            <div class='clear'></div>
                                        </div>
                                        ...
                                        <div class='form-field-box odd'>
                                         ...
                                         <div class='form-field-box odd'>
                                            ...
                                            <div class='form-input-box'>
                                                <input class='form-control' name='password' value="<?= $row->password ?>" type='text' />                
                                            </div>
                                            <br>
                                            <div class='clear'></div>
                                        </div>
                                        ...
                                        <div class='form-field-box odd'>
                                            ...
                                            <div class='form-input-box'>
                                                <select style="width: 100%" id='field-status' name='status' class='chosen-select' data-placeholder='Select status'>  
                                                    <?php if ($row->status == 1){?>
