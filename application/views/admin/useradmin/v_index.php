...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
            	<div class="col-md-12">
            		<a href="<?= base_url('admin/useradmin/tambah') ?>">
                        <button class="btn btn-success"><i class="fa fa-plus" aria-hidden="true"></i> Tambah Admin</button>
                    </a>
                    <br><br>
            				...
            				<?php foreach ($data as $key): ?>
            					<tr>
            						...
            						<td style="text-align: center;">
                                        <?php if ($key->status == 1): ?>
                                              <span style="background-color: green" class="badge badge-success">Aktif</span>
                                              <?php else: ?>
                                              <span class="badge badge-danger">Tidak Aktif</span>    
                                        <?php endif ?>      
                                    </td>
            						<td style="text-align: center;">
            							<a href="<?= base_url('admin/useradmin/detail/'.$key->id) ?>">
            								<button class="btn btn-primary"><i class="fa fa-eye" aria-hidden="true"></i> Detail</button>
            							</a>
                                        <a href="<?= base_url('admin/useradmin/update/'.$key->id) ?>">
