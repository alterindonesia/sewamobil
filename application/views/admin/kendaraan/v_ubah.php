                            ...
                            <!-- <form action="" method="post" enctype="multipart/form-data" accept-charset="utf-8" style="margin-bottom: 10%; border: #e0e0e0 2px solid; padding: 20px" id="main-form"> -->
                                    <div class="submit" id="onSubmit">
                                        <div class='form-field-box odd'>
                                            ...
                                            <div class='form-input-box'>
                                                <select style="width: 100%" id='field-status' name='id_merk' class='chosen-select' data-placeholder='Select Merk'>  
                                                    <option value="<?= $row->id_merk ?>" selected="selected"><?= $row->nama_merk ?></option>  
                                        ...
                                        <div class='form-field-box odd'>
                                            ...
                                            <div class='form-input-box'>
                                                <input class='form-control' name='type' value="<?= $row->type ?>" type='text'/>                
                                            </div>
                                            <br>
                                            <div class='clear'></div>
                                        </div>
                                        <div class='form-field-box odd'>
                                            ...
                                            <div class='form-input-box'>
                                                <select style="width: 100%" id='field-status' name='transmisi' class='chosen-select' data-placeholder='Select Transmisi'> 
                                                    ...
                                                    <option <?php if($row->transmisi == "Manual"){ echo 'selected="selected"'; } ?> value="Manual">Manual</option>  
                                                    <option <?php if($row->transmisi == "Automatic"){ echo 'selected="selected"'; } ?> value="Automatic">Automatic</option>
                                                </select>               
                                            </div>
                                            <br>
                                            <div class='clear'></div>
                                        ...
                                        <div class='form-field-box odd'>
                                            ...
                                            <div class='form-input-box'>
                                                <input class='form-control' name='jumlah_kursi' value="<?= $row->jumlah_kursi ?>" type='number'/>                
                                            </div>
                                            <br>
                                            <div class='clear'></div>
                                        </div> 
                                        <div class='form-field-box odd'>
                                            ...
                                            <div class='form-input-box'>
                                                <input class='form-control' name='plat_nomor' value="<?= $row->plat_nomor ?>" type='text'/>                
                                            </div>
                                            <br>
                                            <div class='clear'></div>
                                        </div>  
                                        <div class='form-field-box odd'>
                                            ...
                                            <div class='form-input-box'>
                                                <select style="width: 100%" id='field-status' name='kategori_plat' class='chosen-select' data-placeholder='Select kategori_plat'>    
                                                    <option <?php if($row->kategori_plat == "Genap"){ echo 'selected="selected"'; } ?> value="Genap">Genap</option>
                                                    <option <?php if($row->kategori_plat == "Ganjil"){ echo 'selected="selected"'; } ?> value="Ganjil">Ganjil</option>
                                                </select>               
                                            </div>
                                            <br>
                                            <div class='clear'></div>
                                        ...
                                        <div class='form-field-box odd'>
                                            ...
                                            <div class='form-input-box'>
                                                <select style="width: 100%" id='field-status' name='bahan_bakar' class='chosen-select' data-placeholder='Select Transmisi'>  
                                                    <option <?php if($row->bahan_bakar == "Pertamax"){ echo 'selected="selected"'; } ?> value="Pertamax">Pertamax</option>
                                                    <option <?php if($row->bahan_bakar == "Premium"){ echo 'selected="selected"'; } ?> value="Premium">Premium</option>
                                                    <option <?php if($row->bahan_bakar == "Pertalite"){ echo 'selected="selected"'; } ?> value="Pertalite">Pertalite</option>
                                                    <option <?php if($row->bahan_bakar == "Solar"){ echo 'selected="selected"'; } ?> value="Solar">Solar</option>
                                                    >
                                                </select>               
                                            </div>
                                            <br>
                                        ...
                                        <div class='form-field-box odd'>
                                            ...
                                            <div class='form-input-box'>
                                                <input class='form-control' name='harga_include_driver' value="<?= $row->harga_include_driver ?>" type='number'/>         
                                            </div>
                                            <br>
                                            <div class='clear'></div>
                                        </div> 
                                        <div class='form-field-box odd'>
                                            ...
                                            <div class='form-input-box'>
                                                <input class='form-control' name='harga_exclude_driver' value="<?= $row->harga_exclude_driver ?>" type='number'/>         
                                            </div>
                                            <br>
                                            <div class='clear'></div>
                                        </div>
                                        <div class='form-field-box odd'>
                                            ...
                                            <div class='form-input-box'>
                                                <img id="imgfile" src="<?php echo base_url('assets/uploads/files/'.$row->file);?>" alt="" width="100"><br><br>    
                                                <input type="file" id="main-gambar" style="display:" name="userfile" value="NULL">
                                                <input type="text" id="gmbr" name="gambar" style="display: none">         
                                            </div>
                                            <br>
                                            <div class='clear'></div>
                                        </div>       
