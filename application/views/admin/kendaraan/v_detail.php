                                    ...
                                    <div class="submit" id="onSubmit">
                                        <div class='form-field-box odd'>
                                            ...
                                            <div class='form-input-box'>
                                                <input class='form-control' name='merk' value="<?= $row->nama_merk ?>" type='text' readonly="readonly"/>                
                                            </div>
                                            <br>
                                            <div class='clear'></div>
                                        </div>
                                        <div class='form-field-box odd'>
                                            ...
                                            <div class='form-input-box'>
                                                <input class='form-control' name='type' value="<?= $row->type ?>" type='text' readonly="readonly"/>                
                                            </div>
                                            <br>
                                            <div class='clear'></div>
                                        </div>
                                        <div class='form-field-box odd'>
                                            ...
                                            <div class='form-input-box'>
                                                <input class='form-control' name='transmisi' value="<?= $row->transmisi ?>" type='text' readonly="readonly"/>                
                                            </div>
                                            <br>
                                            <div class='clear'></div>
                                        </div>
                                        ...
                                        <div class='form-field-box odd'>
                                            ...
                                            <div class='form-input-box'>
                                                <input class='form-control' name='jumlah_kursi' value="<?= $row->jumlah_kursi ?>" type='text' readonly="readonly"/>                
                                            </div>
                                            <br>
                                            <div class='clear'></div>
                                        </div> 
                                        ...
                                        <div class='form-field-box odd'>
                                            ...
                                            <div class='form-input-box'>
                                                <input class='form-control' name='kategori_plat' value="<?= $row->kategori_plat ?>" type='text' readonly="readonly"/>                
                                            </div>
                                            <br>
                                            <div class='clear'></div>
                                        </div>
                                        ...
                                        <div class='form-field-box odd'>
                                            ...
                                            <div class='form-input-box'>
                                                <input class='form-control' name='bahan_bakar' value="<?= $row->bahan_bakar ?>" type='text' readonly="readonly"/>                
                                            </div>
                                            <br>
                                            <div class='clear'></div>
                                        </div> 
                                        ...
                                        <div class='form-field-box odd'>
                                            ...
                                            <div class='form-input-box'>
                                                <input class='form-control' name='harga_include_driver' value="Rp<?= number_format($row->harga_include_driver) ?>" type='text' readonly="readonly"/>         
                                            </div>
                                            <br>
                                            <div class='clear'></div>
                                        </div> 
                                        <div class='form-field-box odd'>
                                            ...
                                            <div class='form-input-box'>
                                                <input class='form-control' name='harga_exclude_driver' value="Rp<?= number_format($row->harga_exclude_driver) ?>" type='text' readonly="readonly"/>         
                                            </div>
                                            <br>
                                            <div class='clear'></div>
                                        </div>
                                        <div class='form-field-box odd'>
                                            ...
                                            <div class='form-input-box'>
                                                <img id="imgfile" src="<?php echo base_url('assets/uploads/files/'.$row->file);?>" alt="" class="img-responsive" style="width: 100%"><br><br>      
                                            </div>
                                            <br>
                                            <div class='clear'></div>
                                        </div>       
